(function () {
    ...
    class Chat {
        ...
        private previousScreen: string | null = null; // Écran actif avant l'overlay game in progress
        ...
        private onInvitedGameEnd(player1: string, player2: string, winner: string): void {
